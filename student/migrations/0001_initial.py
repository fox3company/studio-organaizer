    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clients', models.ManyToManyField(blank=True, related_name='lessons', to='student.client')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cl_tr_id', models.PositiveIntegerField(blank=True, editable=False, null=True)),
                ('type_of_tr', models.CharField(choices=[('+', 'Payment'), ('-', 'Visit ~ -1 lesson from the account')], default='+', max_length=9)),
        ...
        migrations.AddField(
            model_name='client',
            name='student_ptr',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='client', to='student.student'),
        ),
    ]
